...
func List_policiesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/policies%s", cfg.BaseURL, queryString)
...
func CreateList_policiesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_policies",
		mcp.WithDescription("List policies"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    List_policiesHandler(cfg),
	}
}
