...
func Get_subscriptionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_subscriptionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId",
		mcp.WithDescription("Get a specific subscription set"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_subscriptionHandler(cfg),
	}
}
