...
func Delete_subscriptionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s", cfg.BaseURL, subscriptionId)
...
func CreateDelete_subscriptionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_subscriptions_subscriptionId",
		mcp.WithDescription("Delete subscriptions of a specific type"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_subscriptionHandler(cfg),
	}
}
