...
func List_image_contentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/images/%s/content", cfg.BaseURL, imageDigest)
...
func CreateList_image_contentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_images_imageDigest_content",
	...
	return models.Tool{
		Definition: tool,
		Handler:    List_image_contentHandler(cfg),
	}
}
