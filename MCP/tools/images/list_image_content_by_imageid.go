...
func List_image_content_by_imageidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/images/by_id/%s/content", cfg.BaseURL, imageId)
...
func CreateList_image_content_by_imageidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_images_by_id_imageId_content",
		mcp.WithDescription("List image content types"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    List_image_content_by_imageidHandler(cfg),
	}
}
