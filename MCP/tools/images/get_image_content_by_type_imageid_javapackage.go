...
func Get_image_content_by_type_imageid_javapackageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/images/by_id/%s/content/java", cfg.BaseURL, imageId)
		...
		var result models.ContentJAVAPackageResponse
...
func CreateGet_image_content_by_type_imageid_javapackageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_images_by_id_imageId_content_java",
		mcp.WithDescription("Get the content of an image by type java"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_image_content_by_type_imageid_javapackageHandler(cfg),
	}
}
