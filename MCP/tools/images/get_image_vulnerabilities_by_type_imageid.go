...
func Get_image_vulnerabilities_by_type_imageidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/images/by_id/%s/vuln/%s", cfg.BaseURL, imageId, vtype)
...
func CreateGet_image_vulnerabilities_by_type_imageidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_images_by_id_imageId_vuln_vtype",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_image_vulnerabilities_by_type_imageidHandler(cfg),
	}
}
