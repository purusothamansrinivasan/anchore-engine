...
func Get_imageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/images/%s", cfg.BaseURL, imageDigest)
...
func CreateGet_imageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_images_imageDigest",
		mcp.WithDescription("Get image metadata"),
