...
func List_user_credentialsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateList_user_credentialsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounts_accountname_users_username_credentials",
		mcp.WithDescription("Get current credential summary"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    List_user_credentialsHandler(cfg),
	}
}
