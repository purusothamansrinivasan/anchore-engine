...
func CreateDelete_userTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_accounts_accountname_users_username",
		mcp.WithDescription("Delete a specific user credential by username of the credential. Cannot be the credential used to authenticate the request."),
