...
func Delete_registryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/registries/%s", cfg.BaseURL, registry)
...
func CreateDelete_registryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_registries_registry",
		mcp.WithDescription("Delete a registry configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_registryHandler(cfg),
	}
}
